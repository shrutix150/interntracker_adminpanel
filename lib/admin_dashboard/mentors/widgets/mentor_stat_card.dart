...
class MentorStatCard extends StatefulWidget {
  ...
  @override
  State<MentorStatCard> createState() => _MentorStatCardState();
}

class _MentorStatCardState extends State<MentorStatCard> {
  bool _hovered = false;
