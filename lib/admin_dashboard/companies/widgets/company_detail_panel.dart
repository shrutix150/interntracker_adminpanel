...
class CompanyDetailPanel extends StatelessWidget {
          ...
          Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: <Color>[
                  company.status.color.withOpacity(0.18),
                  AppColors.surface,
                ...
                Expanded(
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Text(
                        'Review partner information, mentor ownership, and assignment load.',
                ...
                children: <Widget>[
                      ...
                      _DetailGrid(
                        children: <Widget>[
                          ...
                          _InfoTile(
                            ...
                            value: '${company.activeInternships}',
                          ),
                        ],
                      ),
                    ],
                  ...
                  if (company.studentPreview.isNotEmpty)
                    _DetailSection(
                      ...
                      children: company.studentPreview
                          .map(
                            (student) => Padding(
...
class _ProfileCard extends StatelessWidget {
  const _ProfileCard({required this.company});
            ...
            children: <Widget>[
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: company.status.color.withOpacity(0.18),
                ),
