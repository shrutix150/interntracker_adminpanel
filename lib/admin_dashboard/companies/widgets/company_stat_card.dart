...
class CompanyStatCard extends StatefulWidget {
  ...
  @override
  State<CompanyStatCard> createState() => _CompanyStatCardState();
}

class _CompanyStatCardState extends State<CompanyStatCard> {
  bool _hovered = false;
