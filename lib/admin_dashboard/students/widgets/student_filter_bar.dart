...
class StudentFilterBar extends StatelessWidget {
  ...
  final StudentYear? selectedYear;
  final StudentInternshipStatus? selectedStatus;
  final String searchQuery;
  final List<String> departmentOptions;
  final ValueChanged<String?> onDepartmentChanged;
  final ValueChanged<StudentYear?> onYearChanged;
  final ValueChanged<StudentInternshipStatus?> onStatusChanged;
      ...
      child: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final List<Widget> controls = <Widget>[
            ...
            _FilterDropdown<StudentYear>(
              label: 'Year',
              value: selectedYear,
              allLabel: 'All years',
              items: StudentYear.values,
              itemLabelBuilder: (item) => item.label,
              onChanged: onYearChanged,
              compactLabel: compactFieldLabels,
            ),
            _FilterDropdown<StudentInternshipStatus>(
              label: 'Status',
      ...
      children: <Widget>[
        ...
        TextFormField(
          ...
          decoration: const InputDecoration(
            hintText: 'Search student name, email, roll number',
            filled: true,
            fillColor: AppColors.background,
